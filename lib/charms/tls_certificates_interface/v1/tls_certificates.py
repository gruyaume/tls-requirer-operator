...
PROVIDER_JSON_SCHEMA = {
    "$schema": "http://json-schema.org/draft-04/schema#",
    "$id": "https://canonical.github.io/charm-relation-interfaces/tls_certificates/v1/schemas/provider.json",
    # noqa: E501
    "type": "object",
    "title": "`tls_certificates` provider root schema",
    "description": "The `tls_certificates` root schema comprises the entire provider databag for this interface.",
    # noqa: E501
    "example": [
        {
            "certificates": [
...
class TLSCertificatesProvidesV1(Object):
    ...
    def set_relation_certificate(
        ...
        provider_relation_data = certificates_relation.data[
            self.model.unit
...
class TLSCertificatesRequiresV1(Object):
    ...
    def _on_relation_changed(self, event: RelationChangedEvent) -> None:
        ...
        Returns:
            None
        """
        provider_relation_data = _load_unit_relation_data(
